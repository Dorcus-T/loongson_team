...
(
    ...
    // if interact
    input  [31:0] vaddr_from_if,
    output [31:0] paddr_to_if,
    output [2:0]  if_tlb_exc,
    output [1:0]  if_mat,

    // id interact
    // ex interact
    input  [31:0] vaddr_from_ex,
    input  [35:0] vtlb_enop,
    input  [1:0]  ld_and_str,
    output [31:0] paddr_to_ex,
    output [5:0]  srch_value,
    output [4:0]  ex_tlb_exc,
    output [1:0]  ex_mat,
    ...
    input  [1:0]  dapg_in,
    input  [63:0] dmw,
    input  [`TLBCSR_BUS_WD - 1:0] tlbcsr,
    output [`TLBRD_BUS_WD - 1:0]  tlbrd_value
);
    // if decode
    wire   [18:0] if_vppn;
    wire          if_va_bit12;
